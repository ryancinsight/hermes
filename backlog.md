...
- Gates: 548 native tests, 16 release tests, 26 doctests (10 existing ignored), Clippy, minimal features, examples, docs and benchmark compile pass. Downstream code removes the forwarding helper and full-tile payload spills. Restored Apollo passes full consumer gates and memory comparisons but remains 10,752 executable bytes above baseline; [draft PR 338](https://github.com/ryancinsight/apollo/pull/338) is not merge-ready.

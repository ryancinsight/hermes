...
- [minor][HS-COMPLEX-TRANSPOSE] Add
  ...
  98.242 ns for the forced generic default. Apollo's unchanged processor-2
  comparison reduces f32 N = 96 from 222.935 ns at entry to 128.429/128.359 ns
  in two adjacent runs while retaining its f64 and N = 64/128 controls. See
  [ADR 004](docs/adr/004-generic-interleaved-complex-kernels.md).

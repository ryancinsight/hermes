...
impl<Backend, Arch, const M: usize, const N: usize, const K: usize>
    TileMatrixMultiply<hermes_numeric::Bf16, hermes_numeric::Bf16, hermes_numeric::F32, Backend, Arch, M, N, K> for Scalar
{
    #[inline]
    unsafe fn tile_matmul(
        c: *mut hermes_numeric::F32, c_stride: usize,
        a: *const hermes_numeric::Bf16, a_stride: usize,
        b: *const hermes_numeric::Bf16, b_stride: usize,
    ) {
        for i in 0..M {
            for j in 0..N {
...
impl<Backend, Arch, const M: usize, const N: usize, const K: usize>
    TileMatrixMultiply<hermes_numeric::I8, hermes_numeric::I8, hermes_numeric::I32, Backend, Arch, M, N, K> for Scalar
{
    #[inline]
    unsafe fn tile_matmul(
        c: *mut hermes_numeric::I32, c_stride: usize,
        a: *const hermes_numeric::I8, a_stride: usize,
        b: *const hermes_numeric::I8, b_stride: usize,
    ) {
        for i in 0..M {
            for j in 0..N {
                let mut sum = (*c.add(i * c_stride + j)).0;

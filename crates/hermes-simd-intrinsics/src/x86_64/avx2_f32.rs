...
use core::arch::x86_64::{
    _mm256_alignr_epi8, _mm256_blend_ps, _mm256_castpd_ps, _mm256_castps_pd,
    _mm256_permute2f128_pd, _mm256_permute2f128_ps, _mm256_set1_pd, _mm256_shuffle_pd,
...
impl BackendKernel<f32> for Avx2 {
    ...
    unsafe fn interleave_halves(a: Self::Vector, b: Self::Vector) -> (Self::Vector, Self::Vector) {
        // The 128-bit halves are one permute each: low halves, then high halves.
        (

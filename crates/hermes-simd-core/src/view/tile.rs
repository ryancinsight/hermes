...
#[repr(C)]
pub struct TileView<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment = Unaligned, Ref: 'a = &'a [T]> {
    ptr: *mut T,
    stride: usize,
    _marker: PhantomData<(&'a T, Backend, Arch, Align, Ref)>,
}

unsafe impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment, Ref: 'a> Send
    for TileView<'a, T, Backend, Arch, ROWS, COLS, Align, Ref>
where
    Ref: Send,
{}

unsafe impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment, Ref: 'a> Sync
    for TileView<'a, T, Backend, Arch, ROWS, COLS, Align, Ref>
where
    Ref: Sync,
{}

impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment, Ref: 'a> Clone
    for TileView<'a, T, Backend, Arch, ROWS, COLS, Align, Ref>
where
    Ref: Clone,
{
...
impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment, Ref: 'a> Copy
    for TileView<'a, T, Backend, Arch, ROWS, COLS, Align, Ref>
where
    Ref: Copy,
{}

impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment>
...
impl<'a, T: NumericElement, Backend, Arch, const ROWS: usize, const COLS: usize, Align: Alignment, Ref: 'a>
